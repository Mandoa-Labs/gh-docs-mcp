...
Before optimizing your budget configuration, make sure you understand how the four budget controls work and how the system evaluates them. See [Budgets for usage-based billing](/en/copilot/concepts/billing/budgets-for-usage-based-billing).
