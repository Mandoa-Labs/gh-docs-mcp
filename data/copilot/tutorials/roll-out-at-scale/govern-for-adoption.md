...
For step-by-step instructions on creating an AI manager role, see [Establishing AI managers in your enterprise](/en/copilot/tutorials/roll-out-at-scale/establish-ai-managers).
...
For setup instructions, see [Using your LLM provider API keys with Copilot](/en/copilot/how-tos/administer-copilot/manage-for-enterprise/use-your-own-api-keys).