...
For full guidance on how to respond to a security incident, including **containment strategies**, see [Responding to a security incident](/en/code-security/tutorials/secure-your-organization/responding-to-security-incidents).
...
* [Containment actions](/en/code-security/tutorials/secure-your-organization/responding-to-security-incidents#step-2-contain-the-threat)
...
| [Dependabot alerts](/en/code-security/how-tos/manage-security-alerts/manage-dependabot-alerts/viewing-and-updating-dependabot-alerts) | Review for alerts relating to vulnerable dependencies              |
...
* [Audit log for an enterprise](/en/enterprise-cloud@latest/admin/monitoring-activity-in-your-enterprise/reviewing-audit-logs-for-your-enterprise/about-the-audit-log-for-your-enterprise)